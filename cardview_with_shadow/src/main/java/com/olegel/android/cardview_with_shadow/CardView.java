...
import com.olegel.android.customcardview2.R;
...
public class CardView extends FrameLayout {
  ...
  private int[] mShadows = new int[2];
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    if (!(IMPL instanceof CustomCardViewApi21Impl)) {
  ...
  private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    float maxElevation = a.getDimension(R.styleable.CardView_cardMaxElevation, 0);*/ //was
    ...
    if(a.hasValue(R.styleable.CardView_cardview_shadow_start_color) &&
            a.hasValue(R.styleable.CardView_cardview_shadow_end_color)){
      mShadows[0] = a.getColor(R.styleable.CardView_cardview_shadow_start_color,
              getResources().getColor(R.color.cardview_shadow_start_color));
      mShadows[1] = a.getColor(R.styleable.CardView_cardview_shadow_end_color,
              getResources().getColor(R.color.cardview_shadow_end_color));
    }else{
      mShadows[0] = getResources().getColor(R.color.cardview_shadow_start_color);
      mShadows[1] = getResources().getColor(R.color.cardview_shadow_end_color);
    }
    a.recycle();
    IMPL.initialize(mCardViewDelegate, context, mBackgroundColor, mRadius,
            mElevation, mMaxElevation,mShadows);
  }
  ...
  public void setShadows(@ColorInt int startShadow, @ColorInt int endShadow){
    mShadows[0] = startShadow;
    mShadows[1] = endShadow;
