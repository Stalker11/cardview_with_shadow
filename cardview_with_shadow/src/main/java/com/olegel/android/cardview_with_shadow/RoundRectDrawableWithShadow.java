...
class RoundRectDrawableWithShadow extends Drawable {
  ...
  RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius,
                              float shadowSize, float maxShadowSize, int[] shaders) {
    mShadowStartColor = shaders[0];//resources.getColor(R.color.cardview_shadow_start_color);
    mShadowEndColor = shaders[1];//resources.getColor(R.color.cardview_shadow_end_color);
